...
urlpatterns = [
    ...
    url(r'^college-list/(?P<pk1>\d+)/$', views.college_detail, name='college_detail'),
    url(r'^college/courses/faculty-list/(?P<pk3>\d+)/$', views.faculty_college, name='faculty_college'),
    url(r'^courses/college/faculty-list/(?P<pk4>\d+)/$', views.faculty_course, name='faculty_course'),
    url(r'^course-list/(?P<pk2>\d+)/$', views.course_detail, name='course_detail'),
